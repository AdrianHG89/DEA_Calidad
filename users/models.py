...
Determina las caracteristicas que van a tener nuestros usuarios ya registrado.
Por asi decirlo un usuario extendido que ya sigue a otros usuarios etc.
"""
